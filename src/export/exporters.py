...
class MapExporter:
    ...
    def export_png(self, fig: plt.Figure, filename: str, dpi: int = PNG_DPI) -> str:
        """
    ...
    def export_pdf(self, fig: plt.Figure, filename: str) -> str:
        """
    ...
    def export_svg(self, fig: plt.Figure, filename: str) -> str:
        """
    ...
    def export_all_formats(
        self, fig: plt.Figure, base_filename: str, formats: Optional[List[str]] = None
    ) -> List[str]:
        """
