...
from ..utils.config import (
    MAP_WIDTH_INCHES, MAP_HEIGHT_INCHES, PRINT_DPI,
    COUNTY_COLORS, COUNTY_EDGE_COLOR, COUNTY_EDGE_WIDTH, COUNTY_ALPHA,
    HIGHWAY_COLOR, HIGHWAY_WIDTH,
    MASJID_COLOR, MASJID_SIZE, MASJID_SYMBOL,
    TITLE_FONT_SIZE
)
...
class USMapRenderer:
    ...
    def create_figure(self) -> Tuple[plt.Figure, plt.Axes]:
        ...
        self.fig, self.ax = plt.subplots(
            figsize=(MAP_WIDTH_INCHES, MAP_HEIGHT_INCHES),
            dpi=self.dpi
        )
